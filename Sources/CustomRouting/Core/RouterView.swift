...
public struct RouterView<Content: View>: View, Router {
    ...
    @State private var fullScreenCover: AnyDestination? = nil
    ...
    public var body: some View {
        NavigationStackIfNeed(path: $path, addNavigationView: addNavigationView) {
            content(self)
                .sheetViewModifier(screen: $showSheet)
                .fullScreenCoverViewModifier(screen: $fullScreenCover)
